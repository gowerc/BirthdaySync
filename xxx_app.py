...
#
# * Clears contents of birthday calendar
# * Pulls birthdays from google sheet
# * Creates new birthday calendar events
#
...
CREDENTIALS_FILE = "./secrets/xxx_credentials.json"
TOKEN_FILE = "./secrets/xxx_token.json"


with open("./secrets/xxx_birthday.json", "r") as fi:
